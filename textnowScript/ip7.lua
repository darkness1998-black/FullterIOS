...
Config.btnSettingTextNow = Pixel.new(260, 257, 16537986)
Config.rectSettingTextNow = Rect.new(115, 799, 223, 820)
Config.btnLogOutTextNow = Pixel.new(380, 830, 6630622)
Config.rectLogOutTextNow = Rect.new(320, 844, 429, 866)
Config.btnConfirm = Pixel.new(451, 785, 2723325)
Config.rectConfirm = Rect.new(458, 773, 567, 794)
...
function logout()
    ...
    usleep(math.random(200000, 1000000))
...
function main()
    ...
    -- toast("UnLoad")
    -- executeCommands("launchctl unload /Library/LaunchDaemons/com.mins.linhvuauto.plist");
    -- usleep(5000000)
    -- toast("Load")
    -- executeCommands("launchctl load /Library/LaunchDaemons/com.mins.linhvuauto.plist");
    -- usleep(5000000)
